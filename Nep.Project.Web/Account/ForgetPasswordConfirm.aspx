<%@ Page Title="ลืมรหัสผ่าน" Language="C#" MasterPageFile="~/MasterPages/Guest.Master" AutoEventWireup="true" CodeBehind="ForgetPasswordConfirm.aspx.cs" Inherits="Nep.Project.Web.Account.ForgetPasswordConfirm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        <asp:Panel runat="server" ID="PanelForgetPassword">
            <div class="form-group form-group-sm" id="OrganizationNameBlock" runat="server">
            ...
            <div class="form-group form-group-sm">
                ...
                <label class="col-sm-2 control-label"><%: Nep.Project.Resources.Model.UserProfile_Email %></label>
                <div class="col-sm-4">
                    <asp:TextBox runat="server" ID="TextBoxEmail" TextMode="Email" ClientIDMode="Inherit" CssClass="form-control" Text="" Enabled="false"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group form-group-sm">
                ...
                <asp:Label ID="Label1" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="TextBoxConfirmPassword"><%: Nep.Project.Resources.Model.UserProfile_ConfirmPassword %></asp:Label>
                <div class="col-sm-4">
