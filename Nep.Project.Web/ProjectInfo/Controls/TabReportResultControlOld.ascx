<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TabReportResultControlOld.ascx.cs" Inherits="Nep.Project.Web.ProjectInfo.Controls.TabReportResultControlOld"  %>
                    ...
                    <div class="form-group form-group-sm">
                        <div class="col-sm-12">
                            <div class="form-horizontal custom-padd">                            
                                ...
                                <div class="col-sm-6">    
                                    <asp:Button runat="server" ID="btnUploadExcel" Text="อัพโหลดไฟล์ผู้เข้าร่วมโครงการ/กิจกรรม"/> 
                                </div>
                                 </div>
                                <div class="form-group form-group-sm">
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-sm-4">
                                         <asp:Button runat="server" ID="Button1" Text="ตรวจสอบผู้เข้าร่วมโครงการ" />
                                    </div>
                                </div>
            ...
            <div class="form-group form-group-sm">
                <div class="col-sm-12 text-center">
                    <asp:Button runat="server" ID="ButtonSaveReportResult" CssClass="btn btn-primary btn-sm" ValidationGroup="SaveProjectReport"
                        Text="<%$ code:Nep.Project.Resources.UI.ButtonSave %>" OnClick="ButtonSaveReportResult_Click" Visible="false"/>
                    ...
                    <asp:Button runat="server" ID="ButtonSaveAndSendProjectReport" CssClass="btn btn-primary btn-sm" Visible="false" ValidationGroup="SaveProjectReport"
                        OnClientClick="return confirm('เมื่อท่านทำการส่งข้อมูลให้เจ้าหน้าที่แล้วจะไม่สามารถแก้ไขข้อมูลในส่วนนี้ได้อีก - ในกรณีที่ต้องการบันทึกข้อมูลโดยยังไม่ส่งข้อมูล ให้กดที่ปุ่ม \'บันทึก\' - ต้องการยืนยันการส่งข้อมูล?');"
