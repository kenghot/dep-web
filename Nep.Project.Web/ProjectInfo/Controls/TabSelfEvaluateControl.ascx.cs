...
{
    public partial class TabSelfEvaluateControl : Nep.Project.Web.Infra.BaseUserControl
    {
        ...
        private string QuestionareGroup = "SELF";
            ...
            try
            {
                if (Page.IsValid)
                {
                    ...
                    if (result.IsCompleted)
                    {
                        ...
                        page.RebindData("TabPanelSelfEvaluate");
