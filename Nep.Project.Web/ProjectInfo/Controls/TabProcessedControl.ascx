<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TabProcessedControl.ascx.cs" Inherits="Nep.Project.Web.ProjectInfo.Controls.TabProcessedControl" %>
    ...
    <ContentTemplate>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">การดำเนินการ</h3>
            </div>
                    ...
                    <div class="form-group form-group-sm" id="AddPlanAddress" runat="server">
                        <div class="col-sm-2">
                            <asp:Button runat="server" ID="ButtonAddPlanAddress" CssClass="btn btn-default btn-sm" 
                                ...
                                OnClientClick="return c2xProc.openAddressForm();" />          
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-8">
                                <nep:DatePicker runat="server" ID="ProcessingPlanStartDate" ClearTime="true" EnabledTextBox="true" 
                                    ValidationGroup="SaveProcessingPlanX" 
                                ...
                                ValidationGroup="SaveProcessingPlanX" SetFocusOnError="true"/>
                            </div>                  
                        </div>
                        <div class="form-group form-group-sm">
