<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectBudgetCopyDetail.ascx.cs" Inherits="Nep.Project.Web.ProjectInfo.Controls.ProjectBudgetCopyDetail" %>
...
<asp:UpdatePanel ID="UpdatePanelProjectBudget" 
                    ...
                    runat="server" >
    <ContentTemplate>
          <div class="form-horizontal"  style="padding-left:50px;" id="divactivity">                            
                ...
                <table style="width:100%" border="1" class="td-border"> 
                        ...
                        <tr>
                            ...
                            <td class="B21">
                                ...
                                <input type="text" min="0" style="width:60px" onblur="khProjBG.B21();" id="B21_2_2_3"  data-bind="kendoNumericTextBox: { value: B21_2_2_3, spinners: false, format: '#,###.##' }" /> วัน
                            </td>
                            <td class="B22"> </td>
                        </tr>
                        <tr>
            ...
            <div class="form-group form-group-sm">
                <div class="col-sm-10 text-center">
                    จำนวนเงินเสนอขอ <asp:Label runat="server" ID="LabelTotalBudgetAmount" Text="#,#0.00 "  ></asp:Label> บาท
                      <asp:Button runat="server"   ID="ButtonCopyBudget" CssClass="btn btn-primary btn-sm"
                        Text="สร้างสำเนางบประมาณ"  
                        OnClientClick=" if (!khProjBG.CheckProjectBudgetValidate()) return false; else return  GetQNModelToServer();"  
                        OnClick="ButtonCopyBudget_Click" ValidationGroup="SaveProjectBudget" />
