...
{
    public partial class TabFollow5MControl : Nep.Project.Web.Infra.BaseUserControl
    {
        ...
        private string QuestionareGroup = "FL5M";
        private string TableAttach = "FOLLOW";
        private string FieldAttach ="FOLLOW_5M";
        ...
        public void BindData()
        {
           ...
           // var result = _projectService.GetProjectReportResult(ProjectID);
            ...
            string script = "";
            script = @"<script type=""text/javascript"" src=""../../Scripts/Vue/FollowUp5M.js?v=" + DateTime.Now.Ticks.ToString() + @"""></script>";
            ...
            var setVueParam = @"//$( document ).ready(function() { 
                               // console.log('set');
                                ...
                                Vue.prototype.$CalulateFollowUp5M = CalulateFollowUp5M;";
            ...
            setVueParam += "appVueQN.getData();";
            setVueParam += @"          
                function SaveAttachmentFiles() {
                   SaveAttachmentToDB(" + ProjectID.ToString() + "," + FileUploadFollowAttachment.Controls[1].ClientID + "," + FileUploadFollowAttachment.Controls[0].ClientID + @", '" + TableAttach + @"', '" + FieldAttach + @"');
            ...
            List<Common.ProjectFunction> functions = _projectService.GetProjectFunction(ProjectID).Data;
                ...
                attachList = att.GetAttachmentOfTable(TableAttach, FieldAttach, ProjectID);
                FileUploadFollowAttachment.ClearChanges();
                FileUploadFollowAttachment.ExistingFiles = attachList;
                FileUploadFollowAttachment.DataBind();
                FileUploadFollowAttachment.Enabled = isEditable;
                //งบประมาณโครงการ
        ...
        protected void ButtonSaveReportResult_Click(object sender, EventArgs e)
        {
            try
            {
                if (Page.IsValid)
                {
                    ...
                    var resultAttach = _projectService.SaveAttachFile(ProjectID, Common.LOVCode.Attachmenttype.PROJECT_FOLLOWUP, FileUploadFollowAttachment.RemovedFiles.ToList(),
                        FileUploadFollowAttachment.AddedFiles.ToList(), TableAttach, FieldAttach);
