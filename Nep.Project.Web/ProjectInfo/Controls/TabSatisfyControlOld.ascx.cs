...
{
    public partial class TabSatisfyControlOld : Nep.Project.Web.Infra.BaseUserControl
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            //scriptTag += string.Format("$('#{0}').kendoNumericTextBox({{format: '#####', max: 100 }});",T_1_2.ClientID);
        ...
        private void AddScriptSummary()
        {
            ...
            ";
            //Page.ClientScript.RegisterStartupScript(this.GetType(), "ScriptForSummary",
            //                 scriptSum, true);
