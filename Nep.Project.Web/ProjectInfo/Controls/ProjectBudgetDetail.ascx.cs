...
{
    public partial class ProjectBudgetDetail : Nep.Project.Web.Infra.BaseUserControl
    {
        ...
        {
            var act = (from acts in _service.GetDB().PROJECTBUDGETACTIVITies where acts.ACTIVITYID == ActivityID select acts).FirstOrDefault();
