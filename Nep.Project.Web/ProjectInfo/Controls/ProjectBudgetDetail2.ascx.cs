...
{
    public partial class ProjectBudgetDetail2 : Nep.Project.Web.Infra.BaseUserControl
    {
        ...
        public Decimal ProjectBudgetID
        {
            get
            {

                return (decimal)ViewState["ProjectBudgetID"];
            }
            set
            {
                ViewState["ProjectBudgetID"] = value;
            }
        }
        ...
        //    string script = Business.QuestionareHelper.QuestionareJS(ActivityID, QuestionareGroup, UpdatePanelProjectBudget.ClientID, hdfIsDisable.ClientID, "", after);
        //    RegisterScriptToDoc();
            ...
            try
            {
                ...
                if (projectId > 0)
                {
                    ...
                    if (result.IsCompleted && result.Data != null)
                    {
                        ...
                        ProjectBudgetID = model.BudgetDetails.FirstOrDefault().ProjectBudgetID;
                        ...
                        var act = model.BudgetActivities.Where(w => w.ActivityID == ActivityID).FirstOrDefault();
        ...
        private string SaveQN()
        {
            ...
            try
            {
                if (true)
                {
                    ...
                    var result = _service.SaveProjectQuestionareResult(ActivityID, QuestionareGroup, hdfQViewModel.Value, true, false,Request.UserHostAddress);
                 ...
                 if (Page.IsValid)
                   {
                    ...
                    decimal? totalAmount = 0;//Convert.ToDecimal(TextBoxTotalAmount.Text.Trim());
                    ...
                    GridViewBudgetDetail_RowCommand(ButtonSave, new GridViewCommandEventArgs(ButtonSave.CommandName, new CommandEventArgs(ButtonSave.CommandName,ButtonSave.CommandArgument)));
                   // GridViewBudgetDetail.UpdateRow(0, true);
        ...
        protected void BindGridViewBudgetDetail()
        {
            ...
            if (result.IsCompleted)
            {
                foreach (var item in result.Data.BudgetDetails.Where(w => w.ActivityID == ActivityID).ToList() )
                {
        ...
        protected void GridViewBudgetDetail_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            String uid = ProjectBudgetID.ToString();
