        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-4 control-value"><asp:Label runat="server" ID="LabelBudgetRequestAmount" />&nbsp;&nbsp;<%=UI.LabelBath %></div>
                        <label class="col-sm-2 control-label"><%= UI.LabelBudgetDetailApprovedAmount %></label>
                        <div class="col-sm-4 control-value"><asp:Label runat="server" ID="LabelApprovedAmount" />&nbsp;&nbsp;<%=UI.LabelBath %></div>
                    </div>
                    <div class="form-group form-group-sm">
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group form-group-sm">
                        <label class="col-sm-8 control-label"><asp:Label ID="LabelContractRefName" runat="server" /><span class="required"></span></label>
                        <div class="col-sm-2">
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    <div class="form-group form-group-sm"><!-- มอบอำนาจหรือไม่ -->
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-10 control-value"><asp:Label ID="LabelContractOrgAddress" runat="server" /></div>                                                      
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="col-sm-2 control-label"><%= Model.Contract_OrgTelephone%></label>
                        <div class="col-sm-4 control-value"><asp:Label ID="LabelContractOrgTelephone" runat="server" /></div>
                        <label class="col-sm-2 control-label"><%= Model.Contract_OrgFax%></label>
                        <div class="col-sm-4 control-value"><asp:Label ID="LabelContractOrgFax" runat="server" /></div>                                    
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="col-sm-2 control-label"><%= Model.Contract_OrgEmail%></label>
                        <div class="col-sm-4 control-value"><asp:Label ID="LabelContractOrgEmail" runat="server" /></div>                               
                    </div>
                </div>
            </div>
            <div class="panel-heading">
