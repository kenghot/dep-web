<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/MasterPages/Popup.Master" AutoEventWireup="true" CodeBehind="ProcessedPopup.aspx.cs" Inherits="Nep.Project.Web.ProjectInfo.ProcessedPopup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal" id="OperationAddressForm">      
        ...
        <div class="form-group form-group-sm">
            <label class="col-sm-2 control-label" data-label="TxtAddress">สถานที่ดำเนินการ<span class="required"></span></label>                        
            <div class="col-sm-10">  
        ...
        <div class="form-group form-group-sm">
            <label class="col-sm-2 control-label" data-label="TxtAddress">รายละเอียดกิจกรรม<span class="required"></span></label>                        
            <div class="col-sm-10">  
                <asp:TextBox ID="TextBoxActivity" runat="server"  TextMode="MultiLine" CssClass="form-control" MaxLength="1000"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="TextBoxActivity" runat="server" CssClass="error-text"
                    ...
                    ValidationGroup="SaveAddress" SetFocusOnError="true"/>                            
                        ...
                        <div class="form-group form-group-sm">
                            <label class="col-sm-2 control-label">วันเริ่มต้นกิจกรรม<span class="required"></span></label>
                            <div class="col-sm-4">
                                <nep:DatePicker runat="server" ID="ProcessStart" ClearTime="true" EnabledTextBox="true" 
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorPlanStartDate" ControlToValidate="ProcessStart" runat="server" CssClass="error-text"
                            ...
                            <label class="col-sm-2 control-label">วันสิ้นสุด<span class="required"></span></label>
                            <div class="col-sm-4">
                                <nep:DatePicker runat="server" ID="ProcessEnd" ClearTime="true" EnabledTextBox="true"
                                     ValidationGroup="SaveProcessingPlan" 
                                    ErrorMessage="<%$ code: String.Format(Nep.Project.Resources.Error.ValidationWrongFormat, Nep.Project.Resources.UI.LebelDate) %>"/> 
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorPlanEndDate" ControlToValidate="ProcessEnd" runat="server" CssClass="error-text"
        ...
        <div class="form-group form-group-sm">
            <label class="col-sm-2 control-label">ไฟล์กิจกรรม</label>
            <div class="col-sm-10">
                <div class="input-file-container single-file">
                    ...
                    <input type="file" id="FileOperationAddress" name="FileOperationAddress" accept=".gif, .jpg, .jpeg, .png, .pdf, .docx"/>               
        ...
        <div class="form-group form-group-sm">
            <div class="col-sm-12 text-center">
                <asp:Button ID="ButtonSaveComment" runat="server" Text="<%$ code:Nep.Project.Resources.UI.ButtonSave%>" CssClass="btn btn-default btn-sm" 
                            OnClientClick="return c2xProcAddress.save()" />
