...
{
    public partial class OperationAddressPopup : Infra.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Int32 provinceID = Convert.ToInt32(provinceList[0].Value);
                ...
                String scriptUrl = ResolveUrl("~/Scripts/manage.operationaddress.js?v=2");
