...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      <!-- dashboard -->
            ...
            <style>
                ...
                .k-i-maximize{background-position:-16px -80px}
                .k-i-close{background-position:-32px -192px}
                .k-i-restore{background-position:-48px -80px}
                 .k-window-titlebar {
    position: absolute;
    width: 100%;
    height: 1.1em;
    ...
    <asp:UpdatePanel ID="UpdatePanelSearch" 
        ...
        <ContentTemplate>
            ...
            <div class="count-alert-followup"><asp:Label ID="LabelTotalIsFollowup" runat="server" /></div>
                            ...
                            <div class="form-group form-group-sm noline">
                                <div class="col-sm-12">
                                    <asp:CheckBoxList ID="CheckBoxListTypeDisabilitys" runat="server" CssClass="form-control-checkbox"
                                        DataValueField="LovID" DataTextField="LovName"></asp:CheckBoxList>
                                </div>
                            </div>                                                
                        </div><!--column right-->
           ...
           <div id="divHelpImg">
                สถานะ  <asp:Image ID="imgHelp" alt="help" onmouseover="$('#divHelpHover')[0].style.display = 'block' "
