...
{
    public partial class NewUserProfileList : Nep.Project.Web.Infra.BasePage
    {
        ...
        {
            var result = _service.ListNewRequestWithCriteria(UserProfileGrid.QueryParameter);
        ...
        protected void UserProfileGrid_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {                
                if(e.Row.DataItem != null){
                    ...
                    String url =   "~/User/UserRequestForm"  ;
        ...
        protected void UserProfileGrid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                var result = _service.DeleteRequestUser(id);
                if (result.IsCompleted)
                {
