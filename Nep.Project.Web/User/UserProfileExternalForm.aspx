<%@ Page Title="แก้ไขข้อมูลผู้ใช้งาน" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="UserProfileExternalForm.aspx.cs" Inherits="Nep.Project.Web.User.UserProfileExternalForm" 
        ...
        <ContentTemplate>
            <div class="form-horizontal">
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox runat="server" ID="TxtEmail" TextMode="Email" ClientIDMode="Inherit" CssClass="form-control" Text="" ReadOnly="true"></asp:TextBox>
                    </div>
