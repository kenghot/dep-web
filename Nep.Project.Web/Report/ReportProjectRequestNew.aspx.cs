...
{
    public partial class ReportProjectRequestNew : Nep.Project.Web.Infra.BasePrintPage
    {
        ...
        {
            ReportViewerProjectRequest.LocalReport.LoadReportDefinition(Common.Web.WebUtility.LoadReportFile("ReportProjectRequestNew.rdlc"));
            ...
            {     
                ...
                if (genInfoResult.IsCompleted)
                {
                    ...
                    if(orgTypeResult.IsCompleted){
                        ...
                        ReportViewerProjectRequest.LocalReport.SetParameters(new Microsoft.Reporting.WebForms.ReportParameter("OrgType1ID", orgTypes[0].Value));
                    ...
                    var budgetListResult = _service.GetListProjectBudgetNew(projectID);
