...
{
    public partial class ReportSummaryProject : Nep.Project.Web.Infra.BasePage
    {
        ...
        {
            ReportViewerSummaryProject.LocalReport.LoadReportDefinition(Common.Web.WebUtility.LoadReportFile("Report1.rdlc"));
            ...
            ReportViewerSummaryProject.LocalReport.DataSources.Add(dataset1);
            ReportViewerSummaryProject.LocalReport.DataSources.Add(dataset2);

            ReportViewerSummaryProject.DataBind();
            ReportViewerSummaryProject.LocalReport.Refresh();
            ReportViewerSummaryProject.Visible = true;
        }
