<%@ Page Language="C#" Title="รายงานสรุปความซ้ำซ้อนผู้รับบริการระดับอำเภอ" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" 
   CodeBehind="ReportOverlapDistrict.aspx.cs"  Inherits="Nep.Project.Web.Report.ReportOverlapDistrict" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <rsweb:ReportViewer runat="server" ID="ReportViewerOverlapDistrict" CssClass="report-viewer" Width="1000px" Height="500px" ProcessingMode="Local" SizeToReportContent="False"
