...
{
    public partial class ReportOverlapDistrict : Nep.Project.Web.Infra.BasePage
    {
        ...
        protected void BindReport()
        {
            ...
            ReportViewerOverlapDistrict.LocalReport.DataSources.Clear();
            ReportViewerOverlapDistrict.LocalReport.LoadReportDefinition(Common.Web.WebUtility.LoadReportFile("ReportOverlapDistrict.rdlc"));
            //Set DataSet
            ...
            ReportViewerOverlapDistrict.LocalReport.DataSources.Add(dataset1);
            ReportViewerOverlapDistrict.DataBind();
            ReportViewerOverlapDistrict.Visible = true;
        }

        private List<ServiceModels.Report.ReportOverlapDistrict> GetTemp()
        {
            List<ServiceModels.Report.ReportOverlapDistrict> list = new List<ServiceModels.Report.ReportOverlapDistrict>();
            ...
            for (int i = 0; i < 11; i++)
            {
                ...
                ServiceModels.Report.ReportOverlapDistrict data = new ServiceModels.Report.ReportOverlapDistrict();
        ...
        private ServiceModels.Report.ReportOverlapDistrict GetTempTypeValue(string str1, string str2)
        {
            ServiceModels.Report.ReportOverlapDistrict data = new ServiceModels.Report.ReportOverlapDistrict();
