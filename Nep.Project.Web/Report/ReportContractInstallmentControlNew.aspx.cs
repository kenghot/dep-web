...
{
    public partial class ReportContractInstallmentControlNew : System.Web.UI.Page
    {
        ...
        private void SaveReportProjectContractCenter(ServiceModels.Report.ReportFormatContract ReportContract, ServiceModels.ProjectInfo.TabContract TabContract)
        {
            ...
            string oldFile = Server.MapPath("~/Content/Files/nep-contract-installment-center.pdf");
            ...
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, ReportContract.ContractNo.Replace("/", " / "), 500, 715, 0);//สัญญาที่ 
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, ReportContract.SignAt, 360, 703, 0);//สัญญานี้ทำขึ้น ณ
            ...
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, subDistrict, 200, 690, 0);//ตำบล
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, district,315, 692, 0);//อำเภอ
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, province, 465, 694, 0);//จังหวัด
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, ReportContract.ContractDate,200, 680, 0); //วันที่ ระหว่าง
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, ReportContract.ContractBy, 300, 670, 0);//โดย
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, ReportContract.Position, 320, 660, 0);//ตำแหน่ง
                                                                                                               //Beer28082021 edit
            if (TabContract.ExtendData != null)
            {
                pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, (TabContract.ExtendData.DirectorPositionLine2 != null) ? TabContract.ExtendData.DirectorPositionLine2 : "", 320, 650, 0);//ตำแหน่ง
                pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, (TabContract.ExtendData.DirectorPositionLine3 != null) ? TabContract.ExtendData.DirectorPositionLine3 : "", 320, 640, 0);//ตำแหน่ง
            }
            ...
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, ReportContract.Amount, 210, 382, 0);//จำนวนเงิน
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, ReportContract.AmountString, 435, 384, 0); //จำนวนเงิน
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, ReportContract.ProjectName, 300, 350, 0);//ชื่อโครงการ
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, approvalNoAndYear, 150, 228, 0); //ครั้งที่
            pdfContentPage1.ShowTextAligned(PdfContentByte.ALIGN_CENTER, approvalDate, 230, 228, 0);//ลงวันที่
            ...
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, (ReportContract.AttachPage1 != null) ? ReportContract.AttachPage1 : "0", 180, 691, 0);
            pdfContentPage3 = checklLengthAttachPage(textAttachPage1, pdfContentPage3); //fucntion check  Length
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, textAttachPage1, 320, 690, 0);
            pdfContentPage3.SetFontAndSize(baseFont, 14);
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, (ReportContract.AttachPage2 != null) ? ReportContract.AttachPage2 : "0", 490, 620, 0);
            pdfContentPage3 = checklLengthAttachPage(textAttachPage2, pdfContentPage3); //fucntion check  Length
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, textAttachPage2, 160, 600, 0);
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_LEFT, approvalNoAndYear, 400, 560, 0);
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, approvalDate, 162, 542, 0);
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, (ReportContract.AttachPage3 != null) ? ReportContract.AttachPage3 : "0", 325, 540, 0);
            pdfContentPage3 = checklLengthAttachPage(textAttachPage3, pdfContentPage3); //fucntion check  Length
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, textAttachPage3, 435, 540, 0);
            pdfContentPage3.SetFontAndSize(baseFont, 14);
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, ReportContract.ContractBy, 330, 330, 0);
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, ReportContract.Position, 330, 310, 0);
            //Beer28082021 edit
            if (TabContract.ExtendData != null)
            {
                pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, (TabContract.ExtendData.DirectorPositionLine2 != null) ? TabContract.ExtendData.DirectorPositionLine2 : "", 330, 289, 0);
                pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, (TabContract.ExtendData.DirectorPositionLine3 != null) ? TabContract.ExtendData.DirectorPositionLine3 : "", 330, 269, 0);

            }
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, contractReceiveFullName, 330, 205, 0);
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, ContractReceivePositionSign, 330, 185, 0);
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, witnessFullName1, 330, 123, 0);
            pdfContentPage3.ShowTextAligned(PdfContentByte.ALIGN_CENTER, witnessFullName2, 330, 60, 0);
