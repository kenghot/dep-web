<%@ Page Language="C#" Title="รายงานโครงการอนุมัติตามกรอบวงเงิน" MasterPageFile="~/MasterPages/Site.Master"  AutoEventWireup="true" 
    CodeBehind="ReportBudgetType.aspx.cs" Inherits="Nep.Project.Web.Report.ReportBudgetType" UICulture="th-TH" Culture="th-TH" %>
            ...
            <div class="form-horizontal">
                <div class="form-group form-group-sm noline">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group form-group-sm">
                            <label class="col-sm-3 control-label">กรอบวงเงิน</label>
                            <div class="col-sm-4">
                                <input id="DdlBudgetType" runat="server" style="width:100%; " /> 
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
