<%@ Page Title="รายงานสถิติเปรียบเทียบความซ้ำซ้อนของผู้รับบริการ" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="ReportStatisticDuplicate.aspx.cs" Inherits="Nep.Project.Web.Report.ReportStatisticDuplicate" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanelSearch" 
        ...
        <ContentTemplate>
            ...
            <rsweb:ReportViewer runat="server" ID="ReportViewerStatisticDuplicate" CssClass="report-viewer" Width="100%" Height="100%" 
