...
{
    public partial class OrganizationForm : Nep.Project.Web.Infra.BasePage
    {
        ...
        public Decimal? OrganizationID
        {
            get
            {
                ...
                {
                    organizationId = Decimal.Parse(Request.QueryString["OrganizationID"]);
                }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if ((!OrganizationID.HasValue) && (UserInfo.ProvinceID.HasValue))
                {
                    ...
                    //ComboBoxDistrict.DataSource = GetDistrict((int)UserInfo.ProvinceID);
        ...
        private void LoadData()
        {
            ...
            if (result.IsCompleted)
            {
                ...
                ButtonDelete.Visible = (IsDeleteRole && data.IsDeleteable);
                 ...
                 //ComboBoxProvince.Enabled = data.IsDeleteable;
            }
            else
            {
        ...
        protected void ButtonSave_Click(Object sender, EventArgs e)
        {
            ...
            if (result.IsCompleted)
            {
                ...
                Page.Response.Redirect("OrganizationForm?success=true&OrganizationID=" + id);
            }
            else
            {
        ...
        public List<ServiceModels.GenericDropDownListData> Bank_GetData()
        {
            ...
            var listRole = OrganizationService.ListBank();
