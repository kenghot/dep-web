...
{
    public partial class OrganizationList : Nep.Project.Web.Infra.BasePage
    {
        ...
        public List<ServiceModels.OrganizationList> OrganizationGrid_GetData(int startRowIndex, int maximumRows, string sortByExpression, out int totalRowCount)
        {
            var result = _service.List(OrganizationGrid.QueryParameter);
            List<ServiceModels.OrganizationList> data = new List<ServiceModels.OrganizationList>();
            totalRowCount = 0;
        ...
        protected void GridOrganization_RowCommand(object sender, GridViewCommandEventArgs e)
        {
