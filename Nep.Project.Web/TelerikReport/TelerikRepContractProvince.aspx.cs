...
using System.Text;
namespace Nep.Project.Web.TelerikReport
{
    public partial class TelerikRepContractProvince : Nep.Project.Web.Infra.BasePrintPage
    {
        ...
        private void BindReport()
        {
            ...
            if (Decimal.TryParse(strProjectID, out projectID))
            {
                ...
                if (reportResult.IsCompleted)
                {
                    ...
                    var rep = new Nep.Project.TelerikReport.Reports.Report1();
                    rep.DataSource = list;
                    typeReportSource.TypeName = typeof(Nep.Project.TelerikReport.Reports.Report1).AssemblyQualifiedName;
                    Telerik.Reporting.InstanceReportSource r = new Telerik.Reporting.InstanceReportSource();
                    r.ReportDocument = rep;

                    this.ReportViewer1.ReportSource = r; // typeReportSource;
