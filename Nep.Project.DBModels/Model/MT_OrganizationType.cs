...
namespace Nep.Project.DBModels.Model
{
    ...
    public partial class MT_OrganizationType
    {
        public MT_OrganizationType()
        {
            this.MT_Organization = new HashSet<MT_Organization>();
            this.OrganizationRegisterEntries = new HashSet<OrganizationRegisterEntry>();
        }
    
        public decimal OrganizationTypeID { get; set; }
        public string OrganizationType { get; set; }
        public string ToBeUnder { get; set; }
        ...
        public virtual ICollection<MT_Organization> MT_Organization { get; set; }
