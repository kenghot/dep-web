...
namespace Nep.Project.Business
{
    public class ReportOverlapService : IServices.IReportOverlapService
    {
        ...
        public ServiceModels.ReturnObject<List<ServiceModels.Report.ReportOverlap>> ListReportOverlap(Decimal? Year, Decimal? ProvinceID, String Name, String IDCardNo)
        {
